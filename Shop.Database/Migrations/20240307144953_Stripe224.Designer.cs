...
namespace Shop.Database.Migrations
{
    ...
    [Migration("20240307144953_Stripe224")]
    partial class Stripe224
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.Models.Stripe", b =>
                {
                    b.Property<int>("StripeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StripeId"), 1L, 1);
            ...
            modelBuilder.Entity("Shop.Domain.Models.Image", b =>
                {
                    b.HasOne("Shop.Domain.Models.Product", "Product")
                        .WithOne("image")
                        .HasForeignKey("Shop.Domain.Models.Image", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shop.Domain.Models.Stripe", b =>
                {
                    b.HasOne("Shop.Domain.Models.Product", "Product")
                        .WithOne("Stripe")
                        .HasForeignKey("Shop.Domain.Models.Stripe", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
